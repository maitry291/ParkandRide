...
public final class DateTimeFormatterBuilder {
    ...
    static final class PadPrinterParserDecorator implements DateTimePrinterParser {
        ...
        public int parse(DateTimeParseContext context, CharSequence text, int position) {
            ...
            if (position > text.length()) {
                ...
                while (pos < endPos) {
                    if (!caseSensitive) {
                        if (!context.charEquals(text.charAt(pos), this.padChar)) {
                            break;
                        }
                    } else if (text.charAt(pos) != this.padChar) {
                        break;
                    }
                    pos++;
                }
    ...
    static class NumberPrinterParser implements DateTimePrinterParser {
        static final int[] EXCEED_POINTS = {0, 10, 100, 1000, 10000, 100000, DurationKt.NANOS_IN_MILLIS, 10000000, 100000000, Utils.SECOND_IN_NANOS};
            ...
            if (i == -2) {
                if (inNano != 0) {
                    ...
                    if (inNano % DurationKt.NANOS_IN_MILLIS == 0) {
                        ...
                        sb.append(Integer.toString(Utils.SECOND_IN_NANOS + inNano).substring(1));
                    }
                }
            ...
            try {
                ...
                try {
                    ...
                    try {
                        ...
                        int hour4 = nano3;
                        int nano4 = position;
                        return dateTimeParseContext2.setParsedField(ChronoField.NANO_OF_SECOND, (long) hour4, nano4, dateTimeParseContext2.setParsedField(ChronoField.INSTANT_SECONDS, ldt.toEpochSecond(ZoneOffset.UTC) + Jdk8Methods.safeMultiply(yearParsed / 10000, (long) SECONDS_PER_10000_YEARS), nano4, pos));
