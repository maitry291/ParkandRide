...
public final class DateTimeFormatter {
    ...
    /* JADX WARNING: Removed duplicated region for block: B:18:0x004f A[ExcHandler: DateTimeParseException (r0v5 'ex' org.threeten.bp.format.DateTimeParseException A[CUSTOM_DECLARE]), Splitter:B:3:0x000f] */
    /* Code decompiled incorrectly, please refer to instructions dump. */
    public org.threeten.bp.temporal.TemporalAccessor parseBest(java.lang.CharSequence r6, org.threeten.bp.temporal.TemporalQuery<?>... r7) {
        /*
            r5 = this;
            ...
            r0 = 0
            org.threeten.bp.format.DateTimeBuilder r0 = r5.parseToBuilder(r6, r0)     // Catch:{ DateTimeParseException -> 0x004f, RuntimeException -> 0x0049 }
            org.threeten.bp.format.ResolverStyle r1 = r5.resolverStyle     // Catch:{ DateTimeParseException -> 0x004f, RuntimeException -> 0x0049 }
            java.util.Set<org.threeten.bp.temporal.TemporalField> r2 = r5.resolverFields     // Catch:{ DateTimeParseException -> 0x004f, RuntimeException -> 0x0049 }
            org.threeten.bp.format.DateTimeBuilder r0 = r0.resolve(r1, r2)     // Catch:{ DateTimeParseException -> 0x004f, RuntimeException -> 0x0049 }
            int r1 = r7.length     // Catch:{ DateTimeParseException -> 0x004f, RuntimeException -> 0x0049 }
            r2 = 0
        L_0x001d:
            if (r2 >= r1) goto L_0x002c
            r3 = r7[r2]     // Catch:{ DateTimeParseException -> 0x004f, RuntimeException -> 0x0049 }
            java.lang.Object r4 = r0.build(r3)     // Catch:{ RuntimeException -> 0x0028, DateTimeParseException -> 0x004f }
            org.threeten.bp.temporal.TemporalAccessor r4 = (org.threeten.bp.temporal.TemporalAccessor) r4     // Catch:{ RuntimeException -> 0x0028, DateTimeParseException -> 0x004f }
            return r4
        L_0x0028:
            r4 = move-exception
            int r2 = r2 + 1
            goto L_0x001d
        L_0x002c:
            org.threeten.bp.DateTimeException r1 = new org.threeten.bp.DateTimeException     // Catch:{ DateTimeParseException -> 0x004f, RuntimeException -> 0x0049 }
            java.lang.StringBuilder r2 = new java.lang.StringBuilder     // Catch:{ DateTimeParseException -> 0x004f, RuntimeException -> 0x0049 }
            r2.<init>()     // Catch:{ DateTimeParseException -> 0x004f, RuntimeException -> 0x0049 }
            java.lang.String r3 = "Unable to convert parsed text to any specified type: "
            java.lang.StringBuilder r2 = r2.append(r3)     // Catch:{ DateTimeParseException -> 0x004f, RuntimeException -> 0x0049 }
            java.lang.String r3 = java.util.Arrays.toString(r7)     // Catch:{ DateTimeParseException -> 0x004f, RuntimeException -> 0x0049 }
            java.lang.StringBuilder r2 = r2.append(r3)     // Catch:{ DateTimeParseException -> 0x004f, RuntimeException -> 0x0049 }
            java.lang.String r2 = r2.toString()     // Catch:{ DateTimeParseException -> 0x004f, RuntimeException -> 0x0049 }
            r1.<init>(r2)     // Catch:{ DateTimeParseException -> 0x004f, RuntimeException -> 0x0049 }
            throw r1     // Catch:{ DateTimeParseException -> 0x004f, RuntimeException -> 0x0049 }
        L_0x0049:
            r0 = move-exception
            org.threeten.bp.format.DateTimeParseException r1 = r5.createError(r6, r0)
            throw r1
        L_0x004f:
            r0 = move-exception
            throw r0
    ...
    public Format toFormat(TemporalQuery<?> query) {
        Jdk8Methods.requireNonNull(query, SearchIntents.EXTRA_QUERY);
