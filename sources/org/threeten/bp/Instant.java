...
public final class Instant extends DefaultInterfaceTemporalAccessor implements Temporal, TemporalAdjuster, Comparable<Instant>, Serializable {
    ...
    public static Instant ofEpochSecond(long epochSecond, long nanoAdjustment) {
        return create(Jdk8Methods.safeAdd(epochSecond, Jdk8Methods.floorDiv(nanoAdjustment, 1000000000)), Jdk8Methods.floorMod(nanoAdjustment, 1000000000));
    }
    ...
    private long nanosUntil(Instant end) {
        return Jdk8Methods.safeAdd(Jdk8Methods.safeMultiply(Jdk8Methods.safeSubtract(end.seconds, this.seconds), 1000000000), (long) (end.nanos - this.nanos));
    }
