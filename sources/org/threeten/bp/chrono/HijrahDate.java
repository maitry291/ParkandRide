...
public final class HijrahDate extends ChronoDateImpl<HijrahDate> implements Serializable {
    ...
    static {
        ...
        while (true) {
            ...
            lArr[i6] = Long.valueOf((long) (i6 * 10631));
            i6++;
        }
        int i7 = 0;
        while (true) {
    ...
    public static HijrahDate of(int prolepticYear, int monthOfYear2, int dayOfMonth2) {
        if (prolepticYear >= 1) {
            return of(HijrahEra.AH, prolepticYear, monthOfYear2, dayOfMonth2);
        }
        return of(HijrahEra.BEFORE_AH, 1 - prolepticYear, monthOfYear2, dayOfMonth2);
    }
    ...
    private static long yearToGregorianEpochDay(int prolepticYear) {
        ...
        if (cycleDays == null) {
            cycleDays = Long.valueOf((long) (cycleNumber * 10631));
        }
    ...
    private static int getDayOfCycle(long epochDay, int cycleNumber) {
        ...
        if (day == null) {
            day = Long.valueOf((long) (cycleNumber * 10631));
        }
    ...
    private static int getMonthOfYear(int dayOfYear2, int year) {
        ...
        if (dayOfYear2 >= 0) {
            for (int i2 = 0; i2 < newMonths.length; i2++) {
                if (dayOfYear2 < newMonths[i2].intValue()) {
                    return i2 - 1;
                }
            }
            return 11;
        ...
        int dayOfYear3 = i;
        for (int i3 = 0; i3 < newMonths.length; i3++) {
            if (dayOfYear3 < newMonths[i3].intValue()) {
                return i3 - 1;
            }
        }
        return 11;
    ...
    private static void addDeviationAsHijrah(int startYear, int startMonth, int endYear, int endMonth, int offset) {
        ...
        if (i < 1) {
            ...
            if (orgStartMonthNums == null) {
                if (!isStartYLeap) {
                    ...
                    while (true) {
                        ...
                        orgStartMonthNums[l] = Integer.valueOf(iArr[l]);
                        l++;
                    }
                } else {
                    ...
                    while (true) {
                        ...
                        orgStartMonthNums[l2] = Integer.valueOf(iArr2[l2]);
                        l2++;
                    }
                }
            }
            ...
            for (int month = 0; month < 12; month++) {
                if (month > i2) {
                    newStartMonthNums[month] = Integer.valueOf(orgStartMonthNums[month].intValue() - i5);
                } else {
            ...
            if (orgStartMonthLengths == null) {
                if (!isStartYLeap) {
                    ...
                    while (true) {
                        ...
                        orgStartMonthLengths[l3] = Integer.valueOf(iArr3[l3]);
                        l3++;
                    }
                } else {
                    ...
                    while (true) {
                        ...
                        orgStartMonthLengths[l4] = Integer.valueOf(iArr4[l4]);
                        l4++;
                    }
                }
            }
            ...
            for (int month2 = 0; month2 < 12; month2++) {
                if (month2 == i2) {
                    newStartMonthLengths[month2] = Integer.valueOf(orgStartMonthLengths[month2].intValue() - i5);
                } else {
                    newStartMonthLengths[month2] = Integer.valueOf(orgStartMonthLengths[month2].intValue());
                }
            }
            ...
            if (i != i3) {
                ...
                for (int j2 = sYearInCycle + 1; j2 < CYCLEYEAR_START_DATE.length; j2++) {
                    startCycles[j2] = Integer.valueOf(startCycles[j2].intValue() - i5);
                }
                ...
                if (sYearInMaxY != sEndInMaxY) {
                    ...
                    while (true) {
                        ...
                        lArr[j3] = Long.valueOf(lArr[j3].longValue() - ((long) i5));
                        j3++;
                        int i6 = startYear;
                        sYearInMaxY = sYearInMaxY2;
                        isStartYLeap = isStartYLeap;
                    }
                    int j4 = sEndInMaxY + 1;
                    while (true) {
                        ...
                        lArr2[j4] = Long.valueOf(lArr2[j4].longValue() + ((long) i5));
                        j4++;
                        orgStartMonthNums = orgStartMonthNums;
                    }
                } else {
                    boolean z = isStartYLeap;
                    Integer[] numArr = orgStartMonthNums;
                }
                ...
                if (endCycles == null) {
                    ...
                    int j5 = 0;
                    while (true) {
                        Integer[] newStartMonthNums2 = newStartMonthNums;
                        if (j5 >= endCycles.length) {
                            break;
                        }
                        endCycles[j5] = Integer.valueOf(CYCLEYEAR_START_DATE[j5]);
                        j5++;
                        newStartMonthNums = newStartMonthNums2;
                    }
                }
                for (int j6 = sEndInCycle + 1; j6 < CYCLEYEAR_START_DATE.length; j6++) {
                    endCycles[j6] = Integer.valueOf(endCycles[j6].intValue() + i5);
                }
            ...
            if (orgEndMonthDays == null) {
                if (!isEndYLeap) {
                    ...
                    while (true) {
                        ...
                        orgEndMonthDays[l5] = Integer.valueOf(iArr5[l5]);
                        l5++;
                    }
                } else {
                    ...
                    while (true) {
                        ...
                        orgEndMonthDays[l6] = Integer.valueOf(iArr6[l6]);
                        l6++;
                    }
                }
            }
            ...
            for (int month3 = 0; month3 < 12; month3++) {
                if (month3 > i4) {
                    newEndMonthDays[month3] = Integer.valueOf(orgEndMonthDays[month3].intValue() + i5);
                } else {
                    newEndMonthDays[month3] = Integer.valueOf(orgEndMonthDays[month3].intValue());
                }
            }
            ...
            if (orgEndMonthLengths == null) {
                if (!isEndYLeap) {
                    ...
                    while (true) {
                        ...
                        orgEndMonthLengths[l7] = Integer.valueOf(iArr7[l7]);
                        l7++;
                    }
                } else {
                    ...
                    while (true) {
                        ...
                        orgEndMonthLengths[l8] = Integer.valueOf(iArr8[l8]);
                        l8++;
                    }
                }
            }
            ...
            for (int month4 = 0; month4 < 12; month4++) {
                if (month4 == i4) {
                    newEndMonthLengths[month4] = Integer.valueOf(orgEndMonthLengths[month4].intValue() + i5);
                } else {
                    newEndMonthLengths[month4] = Integer.valueOf(orgEndMonthLengths[month4].intValue());
                }
            }
            HashMap<Integer, Integer[]> hashMap = ADJUSTED_MONTH_LENGTHS;
            hashMap.put(Integer.valueOf(endYear), newEndMonthLengths);
            Integer[] startMonthLengths = hashMap.get(Integer.valueOf(startYear));
            Integer[] endMonthLengths = hashMap.get(Integer.valueOf(endYear));
            HashMap<Integer, Integer[]> hashMap2 = ADJUSTED_MONTH_DAYS;
            boolean z2 = isEndYLeap;
            Integer[] endMonthDays = hashMap2.get(Integer.valueOf(endYear));
            int startMonthLength = startMonthLengths[i2].intValue();
            int endMonthLength = endMonthLengths[i4].intValue();
            int startMonthDay = hashMap2.get(Integer.valueOf(startYear))[11].intValue() + startMonthLengths[11].intValue();
            Integer[] numArr4 = endMonthDays;
            int endMonthDay = endMonthDays[11].intValue() + endMonthLengths[11].intValue();
            Integer[] numArr5 = ADJUSTED_MAX_VALUES;
            int maxMonthLength = numArr5[5].intValue();
            Integer[] numArr6 = ADJUSTED_LEAST_MAX_VALUES;
            int leastMaxMonthLength = numArr6[5].intValue();
            ...
            numArr5[5] = Integer.valueOf(maxMonthLength);
            ...
            numArr6[5] = Integer.valueOf(leastMaxMonthLength);
            int i7 = endMonthLength;
            int maxMonthDay = numArr5[6].intValue();
            int i8 = maxMonthLength;
            int leastMaxMonthDay = numArr6[6].intValue();
            ...
            numArr5[6] = Integer.valueOf(maxMonthDay);
            ...
            numArr6[6] = Integer.valueOf(leastMaxMonthDay);
        } else {
    ...
    private static void parseLine(String line, int num) throws ParseException {
        ...
        while (st.hasMoreTokens()) {
            ...
            if (offsetIndex != -1) {
                try {
                    int offset = Integer.parseInt(deviationElement.substring(offsetIndex + 1, deviationElement.length()));
