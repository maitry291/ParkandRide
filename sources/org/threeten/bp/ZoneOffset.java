...
public final class ZoneOffset extends ZoneId implements TemporalAccessor, TemporalAdjuster, Comparable<ZoneOffset>, Serializable {
    ...
    public static ZoneOffset ofTotalSeconds(int totalSeconds2) {
        if (Math.abs(totalSeconds2) > MAX_SECONDS) {
            throw new DateTimeException("Zone offset not in valid range: -18:00 to +18:00");
        } else if (totalSeconds2 % TypedValues.Custom.TYPE_INT != 0) {
    ...
    public void writeExternal(DataOutput out) throws IOException {
        ...
        int offsetByte = offsetSecs % TypedValues.Custom.TYPE_INT == 0 ? offsetSecs / TypedValues.Custom.TYPE_INT : WorkQueueKt.MASK;
    ...
    static ZoneOffset readExternal(DataInput in) throws IOException {
        ...
        return ofTotalSeconds(offsetByte == 127 ? in.readInt() : offsetByte * TypedValues.Custom.TYPE_INT);
    }
}
