...
public final class ConflatedBroadcastChannel<E> implements BroadcastChannel<E> {
    ...
    public Object m1217trySendJP2dKIU(E element) {
        Closed it = offerInternal(element);
        if (it != null) {
            return ChannelResult.Companion.m1214closedJP2dKIU(it.getSendException());
        }
    ...
    private final kotlinx.coroutines.channels.ConflatedBroadcastChannel.Closed offerInternal(E r14) {
        ...
        L_0x000f:
            ...
            r2 = r4
            kotlinx.coroutines.channels.ConflatedBroadcastChannel$Closed r2 = (kotlinx.coroutines.channels.ConflatedBroadcastChannel.Closed) r2     // Catch:{ all -> 0x006d }
        L_0x001b:
            r13._updating = r1
            return r2
        L_0x001e:
        ...
        L_0x0050:
            ...
            java.lang.StringBuilder r2 = r2.append(r4)     // Catch:{ all -> 0x006d }
