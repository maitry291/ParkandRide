...
public final class ArrayBroadcastChannel<E> extends AbstractSendChannel<E> implements BroadcastChannel<E> {
    ...
    /* JADX WARNING: Code restructure failed: missing block: B:47:0x00af, code lost:
        if (kotlinx.coroutines.DebugKt.getASSERTIONS_ENABLED() == false) goto L_0x00c5;
     */
    /* JADX WARNING: Code restructure failed: missing block: B:51:0x00b5, code lost:
        if (r0 != kotlinx.coroutines.CancellableContinuationImplKt.RESUME_TOKEN) goto L_0x00ba;
     */
    ...
    /* JADX WARNING: Code restructure failed: missing block: B:62:?, code lost:
        r1.buffer[(int) (r9 % ((long) r1.capacity))] = r4.getPollResult();
        setSize(r15 + 1);
        setTail(r9 + 1);
    ...
    private final void updateHead(kotlinx.coroutines.channels.ArrayBroadcastChannel.Subscriber<E> r26, kotlinx.coroutines.channels.ArrayBroadcastChannel.Subscriber<E> r27) {
        ...
        L_0x0032:
            ...
            return
        L_0x0049:
            long r2 = r25.computeMinHead()     // Catch:{ all -> 0x0124 }
            long r9 = r25.getTail()     // Catch:{ all -> 0x0124 }
            long r11 = r25.getHead()     // Catch:{ all -> 0x0124 }
            long r13 = kotlin.ranges.RangesKt.coerceAtMost((long) r2, (long) r9)     // Catch:{ all -> 0x0124 }
            int r15 = (r13 > r11 ? 1 : (r13 == r11 ? 0 : -1))
            if (r15 > 0) goto L_0x0061
            r7.unlock()
            return
        L_0x0061:
            int r15 = r25.getSize()     // Catch:{ all -> 0x0124 }
        L_0x0065:
            int r16 = (r11 > r13 ? 1 : (r11 == r13 ? 0 : -1))
            if (r16 >= 0) goto L_0x011f
            java.lang.Object[] r0 = r1.buffer     // Catch:{ all -> 0x0117 }
            r17 = r2
            int r2 = r1.capacity     // Catch:{ all -> 0x0117 }
            r19 = r4
            long r3 = (long) r2
            long r3 = r11 % r3
            int r4 = (int) r3     // Catch:{ all -> 0x010f }
            r3 = 0
            r0[r4] = r3     // Catch:{ all -> 0x010f }
        ...
        L_0x007d:
            r20 = 1
            long r11 = r11 + r20
            r1.setHead(r11)     // Catch:{ all -> 0x010f }
            int r15 = r15 + -1
            r1.setSize(r15)     // Catch:{ all -> 0x010f }
            if (r2 == 0) goto L_0x0105
            r4 = r19
        L_0x008d:
            kotlinx.coroutines.channels.Send r19 = r25.takeFirstSendOrPeekClosed()     // Catch:{ all -> 0x0124 }
            if (r19 != 0) goto L_0x0097
            r2 = r17
            goto L_0x0065
        L_0x0097:
            r4 = r19
            boolean r0 = r4 instanceof kotlinx.coroutines.channels.Closed     // Catch:{ all -> 0x0124 }
            if (r0 != 0) goto L_0x00fd
            kotlin.jvm.internal.Intrinsics.checkNotNull(r4)     // Catch:{ all -> 0x0124 }
            r0 = 0
            kotlinx.coroutines.internal.Symbol r16 = r4.tryResumeSend(r0)     // Catch:{ all -> 0x0124 }
            r19 = r16
            r0 = r19
            if (r0 == 0) goto L_0x00f6
            boolean r19 = kotlinx.coroutines.DebugKt.getASSERTIONS_ENABLED()     // Catch:{ all -> 0x0124 }
        ...
        L_0x00c5:
            java.lang.Object[] r3 = r1.buffer     // Catch:{ all -> 0x0124 }
            r19 = r0
            int r0 = r1.capacity     // Catch:{ all -> 0x0124 }
            r23 = r5
            r24 = r6
            long r5 = (long) r0
            long r5 = r9 % r5
            int r0 = (int) r5     // Catch:{ all -> 0x00f4 }
            java.lang.Object r5 = r4.getPollResult()     // Catch:{ all -> 0x00f4 }
            r3[r0] = r5     // Catch:{ all -> 0x00f4 }
            int r0 = r15 + 1
            r1.setSize(r0)     // Catch:{ all -> 0x00f4 }
            long r5 = r9 + r20
            r1.setTail(r5)     // Catch:{ all -> 0x00f4 }
