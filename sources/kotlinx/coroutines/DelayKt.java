...
public final class DelayKt {
    ...
    public static final Object m1180delayVtjQ1oo(long duration, Continuation<? super Unit> $completion) {
        Object delay = delay(m1181toDelayMillisLRDsOJo(duration), $completion);
    ...
    public static final long m1181toDelayMillisLRDsOJo(long $this$toDelayMillis_u2dLRDsOJo) {
        if (Duration.m1015compareToLRDsOJo($this$toDelayMillis_u2dLRDsOJo, Duration.Companion.m1118getZEROUwyO8pc()) > 0) {
            return RangesKt.coerceAtLeast(Duration.m1034getInWholeMillisecondsimpl($this$toDelayMillis_u2dLRDsOJo), 1);
        }
        return 0;
    }
}
