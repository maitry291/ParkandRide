...
public final class HandlerDispatcherKt {
    ...
    static {
        ...
        try {
            ...
            obj = Result.m1390constructorimpl(new HandlerContext(asHandler(Looper.getMainLooper(), true), (String) null, 2, (DefaultConstructorMarker) null));
        } catch (Throwable th) {
            Result.Companion companion2 = Result.Companion;
            obj = Result.m1390constructorimpl(ResultKt.createFailure(th));
        }
        if (!Result.m1396isFailureimpl(obj)) {
    ...
    public static final void m1188postFrameCallback$lambda6(CancellableContinuation $cont, long nanos) {
