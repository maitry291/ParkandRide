...
public class SharedFlowImpl<T> extends AbstractSharedFlow<SharedFlowSlot> implements MutableSharedFlow<T>, CancellableFlow<T>, FusibleFlow<T> {
    ...
    /* JADX WARNING: Code restructure failed: missing block: B:30:0x00a7, code lost:
        if (r4 != kotlinx.coroutines.flow.SharedFlowKt.NO_VALUE) goto L_0x00bc;
     */
    ...
    /* JADX WARNING: Code restructure failed: missing block: B:32:0x00b8, code lost:
        if (r3.awaitValue(r8, r9) != r1) goto L_0x00bb;
     */
    ...
    /* JADX WARNING: Code restructure failed: missing block: B:38:0x00d0, code lost:
        if (r2.emit(r4, r9) != r1) goto L_0x00d3;
     */
    ...
    static /* synthetic */ java.lang.Object collect$suspendImpl(kotlinx.coroutines.flow.SharedFlowImpl r7, kotlinx.coroutines.flow.FlowCollector r8, kotlin.coroutines.Continuation r9) {
        ...
        L_0x002d:
            ...
            kotlin.ResultKt.throwOnFailure(r0)     // Catch:{ all -> 0x00d7 }
            r6 = r2
            r2 = r7
            r7 = r6
            goto L_0x00d6
        ...
        L_0x006b:
            ...
            kotlinx.coroutines.flow.SharedFlowSlot r8 = (kotlinx.coroutines.flow.SharedFlowSlot) r8
            boolean r2 = r7 instanceof kotlinx.coroutines.flow.SubscribedFlowCollector     // Catch:{ all -> 0x00d7 }
            if (r2 == 0) goto L_0x008e
            r2 = r7
            kotlinx.coroutines.flow.SubscribedFlowCollector r2 = (kotlinx.coroutines.flow.SubscribedFlowCollector) r2     // Catch:{ all -> 0x00d7 }
            r9.L$0 = r3     // Catch:{ all -> 0x00d7 }
            r9.L$1 = r7     // Catch:{ all -> 0x00d7 }
            r9.L$2 = r8     // Catch:{ all -> 0x00d7 }
            r4 = 1
            r9.label = r4     // Catch:{ all -> 0x00d7 }
            java.lang.Object r2 = r2.onSubscription(r9)     // Catch:{ all -> 0x00d7 }
            if (r2 != r1) goto L_0x008e
            return r1
        L_0x008e:
            r2 = 0
            kotlin.coroutines.CoroutineContext r4 = r9.getContext()     // Catch:{ all -> 0x00d7 }
            kotlinx.coroutines.Job$Key r2 = kotlinx.coroutines.Job.Key     // Catch:{ all -> 0x00d7 }
            kotlin.coroutines.CoroutineContext$Key r2 = (kotlin.coroutines.CoroutineContext.Key) r2     // Catch:{ all -> 0x00d7 }
            kotlin.coroutines.CoroutineContext$Element r2 = r4.get(r2)     // Catch:{ all -> 0x00d7 }
            kotlinx.coroutines.Job r2 = (kotlinx.coroutines.Job) r2     // Catch:{ all -> 0x00d7 }
        L_0x009d:
            r6 = r2
            r2 = r7
            r7 = r6
        L_0x00a0:
            java.lang.Object r4 = r3.tryTakeValue(r8)     // Catch:{ all -> 0x00d7 }
            kotlinx.coroutines.internal.Symbol r5 = kotlinx.coroutines.flow.SharedFlowKt.NO_VALUE     // Catch:{ all -> 0x00d7 }
            if (r4 != r5) goto L_0x00bc
            r9.L$0 = r3     // Catch:{ all -> 0x00d7 }
            r9.L$1 = r2     // Catch:{ all -> 0x00d7 }
            r9.L$2 = r8     // Catch:{ all -> 0x00d7 }
            r9.L$3 = r7     // Catch:{ all -> 0x00d7 }
            r4 = 2
            r9.label = r4     // Catch:{ all -> 0x00d7 }
            java.lang.Object r4 = r3.awaitValue(r8, r9)     // Catch:{ all -> 0x00d7 }
        ...
        L_0x00bc:
            ...
            kotlinx.coroutines.JobKt.ensureActive((kotlinx.coroutines.Job) r7)     // Catch:{ all -> 0x00d7 }
        L_0x00c1:
            r9.L$0 = r3     // Catch:{ all -> 0x00d7 }
            r9.L$1 = r2     // Catch:{ all -> 0x00d7 }
            r9.L$2 = r8     // Catch:{ all -> 0x00d7 }
            r9.L$3 = r7     // Catch:{ all -> 0x00d7 }
            r5 = 3
            r9.label = r5     // Catch:{ all -> 0x00d7 }
            java.lang.Object r5 = r2.emit(r4, r9)     // Catch:{ all -> 0x00d7 }
    ...
    public boolean tryEmit(T value) {
        ...
        for (Continuation cont : continuationArr) {
            if (cont != null) {
                ...
                cont.resumeWith(Result.m1390constructorimpl(Unit.INSTANCE));
            }
        }
        return emitted;
    }
    ...
    public final Object emitSuspend(T value, Continuation<? super Unit> $completion) {
        ...
        for (Continuation r : continuationArr) {
            if (r != null) {
                ...
                r.resumeWith(Result.m1390constructorimpl(Unit.INSTANCE));
            }
        }
    ...
    private final Object tryTakeValue(SharedFlowSlot slot) {
        ...
        for (Continuation resume : continuationArr) {
            if (resume != null) {
                Result.Companion companion = Result.Companion;
                resume.resumeWith(Result.m1390constructorimpl(Unit.INSTANCE));
            }
        }
        return value;
    }
