...
public abstract class FragmentManager implements FragmentResultOwner {
    ...
    public /* synthetic */ void m1298lambda$new$0$androidxfragmentappFragmentManager(Configuration newConfig) {
        if (isParentAdded()) {
    ...
    public /* synthetic */ void m1299lambda$new$1$androidxfragmentappFragmentManager(Integer level) {
    ...
    public /* synthetic */ void m1300lambda$new$2$androidxfragmentappFragmentManager(MultiWindowModeChangedInfo info) {
        if (isParentAdded()) {
    ...
    public /* synthetic */ void m1301lambda$new$3$androidxfragmentappFragmentManager(PictureInPictureModeChangedInfo info) {
        if (isParentAdded()) {
    ...
    public Parcelable saveAllState() {
        ...
        Bundle savedState = m1297lambda$attachController$4$androidxfragmentappFragmentManager();
    ...
    public Bundle m1297lambda$attachController$4$androidxfragmentappFragmentManager() {
        int size;
    ...
    /* JADX DEBUG: Multi-variable search result rejected for TypeSearchVarInfo{r0v30, resolved type: androidx.activity.OnBackPressedDispatcherOwner} */
    ...
    public void attachController(androidx.fragment.app.FragmentHostCallback<?> r7, androidx.fragment.app.FragmentContainer r8, final androidx.fragment.app.Fragment r9) {
        ...
        L_0x0062:
            ...
            r0.setNonConfig(r1)
            androidx.fragment.app.FragmentHostCallback<?> r0 = r6.mHost
            boolean r1 = r0 instanceof androidx.savedstate.SavedStateRegistryOwner
