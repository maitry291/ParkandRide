    ...
    public final R runCallLoop() {
        while (true) {
            ...
            if (cont2 == null) {
                ...
                return result2;
            } else if (Result.m1392equalsimpl0(DeepRecursiveKt.UNDEFINED_RESULT, result2)) {
                try {
                    ...
                    if (r != IntrinsicsKt.getCOROUTINE_SUSPENDED()) {
                        ...
                        cont2.resumeWith(Result.m1390constructorimpl(r));
                    }
                } catch (Throwable e) {
                    Result.Companion companion2 = Result.Companion;
                    cont2.resumeWith(Result.m1390constructorimpl(ResultKt.createFailure(e)));
                }
            } else {
