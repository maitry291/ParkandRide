...
public final class UStringsKt {
    ...
    public static final String m999toStringLxnNnR4(byte $this$toString_u2dLxnNnR4, int radix) {
    ...
    public static final String m1001toStringolVBNx4(short $this$toString_u2dolVBNx4, int radix) {
    ...
    public static final String m1000toStringV7xB4Y4(int $this$toString_u2dV7xB4Y4, int radix) {
    ...
    public static final String m998toStringJSWoG40(long $this$toString_u2dJSWoG40, int radix) {
    ...
    public static final short toUShort(String $this$toUShort) {
        ...
        if (uShortOrNull != null) {
            return uShortOrNull.m1717unboximpl();
        }
    ...
    public static final int toUInt(String $this$toUInt) {
        ...
        if (uIntOrNull != null) {
            return uIntOrNull.m1535unboximpl();
        }
    ...
    public static final long toULong(String $this$toULong) {
        ...
        if (uLongOrNull != null) {
            return uLongOrNull.m1613unboximpl();
        }
    ...
    public static final UByte toUByteOrNull(String $this$toUByteOrNull, int radix) {
        ...
        int r0 = uIntOrNull.m1535unboximpl();
        if (UnsignedKt.uintCompare(r0, UInt.m1484constructorimpl(255)) > 0) {
            return null;
        }
        return UByte.m1402boximpl(UByte.m1408constructorimpl((byte) r0));
    }
    ...
    public static final UShort toUShortOrNull(String $this$toUShortOrNull, int radix) {
        ...
        int r0 = uIntOrNull.m1535unboximpl();
        if (UnsignedKt.uintCompare(r0, UInt.m1484constructorimpl(SupportMenu.USER_MASK)) > 0) {
            return null;
        }
        return UShort.m1662boximpl(UShort.m1668constructorimpl((short) r0));
    }
    ...
    public static final UInt toUIntOrNull(String $this$toUIntOrNull, int radix) {
        ...
        int uradix = UInt.m1484constructorimpl(radix);
        int result = 0;
        for (int i = start; i < length; i++) {
            ...
            if (UnsignedKt.uintCompare(result, limitBeforeMul) > 0) {
                ...
                limitBeforeMul = UnsignedKt.m1737uintDivideJ1ME1BU(-1, uradix);
                if (UnsignedKt.uintCompare(result, limitBeforeMul) > 0) {
                    return null;
                }
            }
            int result2 = UInt.m1484constructorimpl(result * uradix);
            int beforeAdding = result2;
            result = UInt.m1484constructorimpl(UInt.m1484constructorimpl(digit) + result2);
            if (UnsignedKt.uintCompare(result, beforeAdding) < 0) {
                return null;
            }
        }
        return UInt.m1478boximpl(result);
    }
    ...
    public static final ULong toULongOrNull(String $this$toULongOrNull, int radix) {
        ...
        long uradix = ULong.m1562constructorimpl((long) i);
        long result = 0;
        int i2 = start;
        while (i2 < length) {
            int length2 = length;
            ...
            if (UnsignedKt.ulongCompare(result, limitBeforeMul) > 0) {
                ...
                limitBeforeMul = UnsignedKt.m1739ulongDivideeb3DHEI(-1, uradix);
                if (UnsignedKt.ulongCompare(result, limitBeforeMul) > 0) {
                    return null;
                }
            }
            long result2 = ULong.m1562constructorimpl(result * uradix);
            long beforeAdding = result2;
            result = ULong.m1562constructorimpl(ULong.m1562constructorimpl(((long) UInt.m1484constructorimpl(digit)) & 4294967295L) + result2);
        ...
        return ULong.m1556boximpl(result);
    }
}
