...
public class ULongProgression implements Iterable<ULong>, KMappedMarker {
    ...
    private ULongProgression(long start, long endInclusive, long step2) {
        if (step2 == 0) {
            ...
            this.first = start;
            this.last = UProgressionUtilKt.m913getProgressionLastElement7ftBX0g(start, endInclusive, step2);
            this.step = step2;
        } else {
    ...
    public final long m935getFirstsVKNKU() {
        return this.first;
    }

    /* renamed from: getLast-s-VKNKU  reason: not valid java name */
    public final long m936getLastsVKNKU() {
        return this.last;
    }
    ...
    public int hashCode() {
        ...
        long j2 = this.last;
        long j3 = this.step;
        return ((int) (j3 ^ (j3 >>> 32))) + (((((int) ULong.m1562constructorimpl(j ^ ULong.m1562constructorimpl(j >>> 32))) * 31) + ((int) ULong.m1562constructorimpl(j2 ^ ULong.m1562constructorimpl(j2 >>> 32)))) * 31);
    }
    ...
    public String toString() {
        ...
        StringBuilder sb2;
        if (this.step > 0) {
            sb2 = sb.append(ULong.m1607toStringimpl(this.first)).append("..").append(ULong.m1607toStringimpl(this.last)).append(" step ");
            j = this.step;
        } else {
            sb = new StringBuilder();
            sb2 = sb.append(ULong.m1607toStringimpl(this.first)).append(" downTo ").append(ULong.m1607toStringimpl(this.last)).append(" step ");
            j = -this.step;
        }
    ...
    public static final class Companion {
        ...
        public final ULongProgression m937fromClosedRange7ftBX0g(long rangeStart, long rangeEnd, long step) {
