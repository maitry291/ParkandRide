...
final class AdjustedTimeMark implements TimeMark {
    ...
    public TimeMark m1010minusLRDsOJo(long duration) {
        return TimeMark.DefaultImpls.m1154minusLRDsOJo(this, duration);
    }

    /* renamed from: getAdjustment-UwyO8pc  reason: not valid java name */
    public final long m1009getAdjustmentUwyO8pc() {
    ...
    public long m1008elapsedNowUwyO8pc() {
        return Duration.m1051minusLRDsOJo(this.mark.m1151elapsedNowUwyO8pc(), this.adjustment);
    }

    /* renamed from: plus-LRDsOJo  reason: not valid java name */
    public TimeMark m1011plusLRDsOJo(long duration) {
        return new AdjustedTimeMark(this.mark, Duration.m1052plusLRDsOJo(this.adjustment, duration), (DefaultConstructorMarker) null);
    }
}
