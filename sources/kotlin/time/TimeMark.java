...
public interface TimeMark {
    ...
    TimeMark m1152minusLRDsOJo(long j);

    /* renamed from: plus-LRDsOJo  reason: not valid java name */
    TimeMark m1153plusLRDsOJo(long j);

    @Metadata(k = 3, mv = {1, 7, 1}, xi = 48)
    /* compiled from: TimeSource.kt */
    public static final class DefaultImpls {
        /* renamed from: plus-LRDsOJo  reason: not valid java name */
        public static TimeMark m1155plusLRDsOJo(TimeMark $this, long duration) {
            return new AdjustedTimeMark($this, duration, (DefaultConstructorMarker) null);
        }

        /* renamed from: minus-LRDsOJo  reason: not valid java name */
        public static TimeMark m1154minusLRDsOJo(TimeMark $this, long duration) {
            return $this.m1153plusLRDsOJo(Duration.m1068unaryMinusUwyO8pc(duration));
        }

        public static boolean hasPassedNow(TimeMark $this) {
            return !Duration.m1049isNegativeimpl($this.m1151elapsedNowUwyO8pc());
        }
