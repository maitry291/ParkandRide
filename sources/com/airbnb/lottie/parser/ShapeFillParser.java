...
class ShapeFillParser {
    ...
    static ShapeFill parse(JsonReader reader, LottieComposition composition) throws IOException {
        ...
        return new ShapeFill(name, fillEnabled, fillTypeInt == 1 ? Path.FillType.WINDING : Path.FillType.EVEN_ODD, color, opacity == null ? new AnimatableIntegerValue(Collections.singletonList(new Keyframe(100))) : opacity, hidden);
    }
}
