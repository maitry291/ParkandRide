...
public class Keyframe<T> {
    ...
    public Keyframe(LottieComposition composition2, T startValue2, T endValue2, Interpolator xInterpolator2, Interpolator yInterpolator2, float startFrame2, Float endFrame2) {
        this.startValueFloat = UNSET_FLOAT;
        this.endValueFloat = UNSET_FLOAT;
        this.startValueInt = UNSET_INT;
        this.endValueInt = UNSET_INT;
        ...
        this.xInterpolator = xInterpolator2;
        this.yInterpolator = yInterpolator2;
        this.startFrame = startFrame2;
        this.endFrame = endFrame2;
    }

    protected Keyframe(LottieComposition composition2, T startValue2, T endValue2, Interpolator interpolator2, Interpolator xInterpolator2, Interpolator yInterpolator2, float startFrame2, Float endFrame2) {
        this.startValueFloat = UNSET_FLOAT;
        this.endValueFloat = UNSET_FLOAT;
        this.startValueInt = UNSET_INT;
        this.endValueInt = UNSET_INT;
