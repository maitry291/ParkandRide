...
public final class Profie$onCreate$2 implements ChildEventListener {
    ...
    public void onChildAdded(DataSnapshot snapshot, String previousChildName) {
        ...
        Chat it = (Chat) snapshot.getValue(Chat.class);
        if (it != null) {
            this.$list.add(it);
        }
    ...
    public void onChildRemoved(DataSnapshot snapshot) {
        Intrinsics.checkNotNullParameter(snapshot, "snapshot");
        TypeIntrinsics.asMutableCollection(this.$list).remove(snapshot.getValue(Chat.class));
        this.$adapter.notifyDataSetChanged();
    }
