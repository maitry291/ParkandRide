...
public final class DynamiteModule {
    ...
    public static DynamiteModule load(Context context, VersionPolicy policy, String moduleId) throws LoadingException {
        ...
        try {
                                    ...
                                    if (bool.booleanValue()) {
                                        ...
                                        if (zzg2 != null) {
                                            ...
                                            if (zze2 >= 3) {
                                                ...
                                                if (zzn4 != null) {
                                                    iObjectWrapper = zzg2.zzi(ObjectWrapper.wrap(context), str, i5, ObjectWrapper.wrap(zzn4.zza));
                                                } else {
                                                    throw new LoadingException("No cached result cursor holder", (zzp) null);
                                                }
                                            } else if (zze2 == 2) {
                                                Log.w("DynamiteModule", "IDynamite loader version = 2");
                                                iObjectWrapper = zzg2.zzj(ObjectWrapper.wrap(context), str, i5);
                                            } else {
                                                Log.w("DynamiteModule", "Dynamite loader version < 2, falling back to createModuleContext");
                                                iObjectWrapper = zzg2.zzh(ObjectWrapper.wrap(context), str, i5);
                                            }
            ...
            throw new LoadingException("No acceptable module " + str + " found. Local version is " + i7 + " and remote version is " + i8 + ".", (zzp) null);
        } finally {
            if (longValue == 0) {
                zzh.remove();
            } else {
