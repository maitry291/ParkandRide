    ...
    public final void zzf(int i) {
        if (zzacn.zzb) {
            ...
            while ((i & -128) != 0) {
                ...
                int i2 = this.zzc;
                this.zzc = i2 + 1;
                zzafx.zzn(bArr, (long) i2, (byte) ((i & WorkQueueKt.MASK) | 128));
                i >>>= 7;
            }
            byte[] bArr2 = this.zza;
            int i3 = this.zzc;
            this.zzc = i3 + 1;
            zzafx.zzn(bArr2, (long) i3, (byte) i);
    ...
    public final void zzg(long j) {
        if (zzacn.zzb) {
            ...
            while ((j & -128) != 0) {
                ...
                int i = this.zzc;
                this.zzc = i + 1;
                zzafx.zzn(bArr, (long) i, (byte) ((((int) j) & WorkQueueKt.MASK) | 128));
                j >>>= 7;
            }
            byte[] bArr2 = this.zza;
            int i2 = this.zzc;
            this.zzc = i2 + 1;
            zzafx.zzn(bArr2, (long) i2, (byte) ((int) j));
