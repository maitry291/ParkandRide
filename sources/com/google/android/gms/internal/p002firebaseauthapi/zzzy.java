...
public final class zzzy extends AbstractSafeParcelable implements zzxn<zzzy> {
    ...
    public static zzzy zzd(String str) {
        try {
            ...
            zzzy zzzy = new zzzy();
            zzzy.zzb = jSONObject.optString("refresh_token", (String) null);
            zzzy.zzc = jSONObject.optString("access_token", (String) null);
            zzzy.zzd = Long.valueOf(jSONObject.optLong("expires_in"));
            zzzy.zze = jSONObject.optString("token_type", (String) null);
            zzzy.zzf = Long.valueOf(jSONObject.optLong("issued_at"));
            return zzzy;
