...
public class TabLayout extends HorizontalScrollView {
    ...
    public TabLayout(android.content.Context r11, android.util.AttributeSet r12, int r13) {
        ...
        L_0x007f:
            ...
            int r1 = com.google.android.material.R.attr.textAppearanceLabelLarge
            r10.defaultTabTextAppearance = r1
            goto L_0x00fa
        L_0x00f6:
            int r1 = com.google.android.material.R.attr.textAppearanceButton
            r10.defaultTabTextAppearance = r1
        L_0x00fa:
            ...
            int r3 = androidx.appcompat.R.styleable.TextAppearance_android_textSize     // Catch:{ all -> 0x0228 }
            int r3 = r2.getDimensionPixelSize(r3, r7)     // Catch:{ all -> 0x0228 }
            float r3 = (float) r3     // Catch:{ all -> 0x0228 }
            r10.tabTextSize = r3     // Catch:{ all -> 0x0228 }
            int r3 = androidx.appcompat.R.styleable.TextAppearance_android_textColor     // Catch:{ all -> 0x0228 }
            android.content.res.ColorStateList r3 = com.google.android.material.resources.MaterialResources.getColorStateList((android.content.Context) r11, (android.content.res.TypedArray) r2, (int) r3)     // Catch:{ all -> 0x0228 }
            r10.tabTextColors = r3     // Catch:{ all -> 0x0228 }
            r2.recycle()
        ...
        L_0x012f:
            ...
            int r3 = androidx.appcompat.R.styleable.TextAppearance_android_textSize     // Catch:{ all -> 0x016c }
            float r4 = r10.tabTextSize     // Catch:{ all -> 0x016c }
            int r4 = (int) r4     // Catch:{ all -> 0x016c }
            int r3 = r1.getDimensionPixelSize(r3, r4)     // Catch:{ all -> 0x016c }
            float r3 = (float) r3     // Catch:{ all -> 0x016c }
            r10.selectedTabTextSize = r3     // Catch:{ all -> 0x016c }
            int r3 = androidx.appcompat.R.styleable.TextAppearance_android_textColor     // Catch:{ all -> 0x016c }
            android.content.res.ColorStateList r3 = com.google.android.material.resources.MaterialResources.getColorStateList((android.content.Context) r11, (android.content.res.TypedArray) r1, (int) r3)     // Catch:{ all -> 0x016c }
            if (r3 == 0) goto L_0x0168
            android.content.res.ColorStateList r4 = r10.tabTextColors     // Catch:{ all -> 0x016c }
            int r4 = r4.getDefaultColor()     // Catch:{ all -> 0x016c }
            int[] r5 = new int[r9]     // Catch:{ all -> 0x016c }
            r8 = 16842913(0x10100a1, float:2.369401E-38)
            r5[r7] = r8     // Catch:{ all -> 0x016c }
            int r8 = r3.getDefaultColor()     // Catch:{ all -> 0x016c }
            int r5 = r3.getColorForState(r5, r8)     // Catch:{ all -> 0x016c }
            android.content.res.ColorStateList r4 = createColorStateList(r4, r5)     // Catch:{ all -> 0x016c }
            r10.tabTextColors = r4     // Catch:{ all -> 0x016c }
        L_0x0168:
            r1.recycle()
            goto L_0x0171
        L_0x016c:
            ...
            throw r3
        L_0x0171:
            int r1 = com.google.android.material.R.styleable.TabLayout_tabTextColor
        ...
        L_0x0181:
            int r1 = com.google.android.material.R.styleable.TabLayout_tabSelectedTextColor
            boolean r1 = r0.hasValue(r1)
        ...
        L_0x019b:
            int r1 = com.google.android.material.R.styleable.TabLayout_tabIconTint
            android.content.res.ColorStateList r1 = com.google.android.material.resources.MaterialResources.getColorStateList((android.content.Context) r11, (android.content.res.TypedArray) r0, (int) r1)
            r10.tabIconTint = r1
            int r1 = com.google.android.material.R.styleable.TabLayout_tabIconTintMode
            ...
            int r1 = com.google.android.material.R.styleable.TabLayout_tabRippleColor
            android.content.res.ColorStateList r1 = com.google.android.material.resources.MaterialResources.getColorStateList((android.content.Context) r11, (android.content.res.TypedArray) r0, (int) r1)
            r10.tabRippleColorStateList = r1
            int r1 = com.google.android.material.R.styleable.TabLayout_tabIndicatorAnimationDuration
            ...
            int r1 = com.google.android.material.R.styleable.TabLayout_tabMinWidth
            int r1 = r0.getDimensionPixelSize(r1, r6)
            r10.requestedTabMinWidth = r1
            int r1 = com.google.android.material.R.styleable.TabLayout_tabMaxWidth
            int r1 = r0.getDimensionPixelSize(r1, r6)
            r10.requestedTabMaxWidth = r1
            int r1 = com.google.android.material.R.styleable.TabLayout_tabBackground
            int r1 = r0.getResourceId(r1, r7)
            r10.tabBackgroundResId = r1
            int r1 = com.google.android.material.R.styleable.TabLayout_tabContentStart
            int r1 = r0.getDimensionPixelSize(r1, r7)
            r10.contentInsetStart = r1
            int r1 = com.google.android.material.R.styleable.TabLayout_tabMode
            int r1 = r0.getInt(r1, r9)
            r10.mode = r1
            int r1 = com.google.android.material.R.styleable.TabLayout_tabGravity
            int r1 = r0.getInt(r1, r7)
            r10.tabGravity = r1
            int r1 = com.google.android.material.R.styleable.TabLayout_tabInlineLabel
            boolean r1 = r0.getBoolean(r1, r7)
            r10.inlineLabel = r1
            int r1 = com.google.android.material.R.styleable.TabLayout_tabUnboundedRipple
            boolean r1 = r0.getBoolean(r1, r7)
    ...
    class SlidingTabIndicator extends LinearLayout {
        ...
        public void jumpIndicatorToSelectedPosition() {
            ...
            TabIndicatorInterpolator access$1600 = TabLayout.this.tabIndicatorInterpolator;
            TabLayout tabLayout = TabLayout.this;
            access$1600.setIndicatorBoundsForTab(tabLayout, currentView, tabLayout.tabSelectedIndicator);
        }
        ...
        public void tweenIndicatorPosition(View startTitle, View endTitle, float fraction) {
            if (startTitle != null && startTitle.getWidth() > 0) {
                TabIndicatorInterpolator access$1600 = TabLayout.this.tabIndicatorInterpolator;
                TabLayout tabLayout = TabLayout.this;
                access$1600.updateIndicatorForOffset(tabLayout, startTitle, endTitle, fraction, tabLayout.tabSelectedIndicator);
            } else {
