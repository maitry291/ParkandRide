...
class MaterialCardViewHelper {
    ...
    public MaterialCardViewHelper(MaterialCardView card, AttributeSet attrs, int defStyleAttr, int defStyleRes) {
        ...
        this.iconFadeAnimDuration = MotionUtils.resolveThemeDuration(card.getContext(), R.attr.motionDurationShort4, DEFAULT_FADE_ANIM_DURATION);
    ...
    public void animateCheckedIcon(boolean checked) {
        ...
        this.iconAnimator.setDuration((long) (((float) this.iconFadeAnimDuration) * delta));
    ...
    public /* synthetic */ void m1331lambda$animateCheckedIcon$0$comgoogleandroidmaterialcardMaterialCardViewHelper(ValueAnimator animation) {
