...
public final class Component<T> {
    ...
    private Component(String name2, Set<Class<? super T>> providedInterfaces2, Set<Dependency> dependencies2, int instantiation2, int type2, ComponentFactory<T> factory2, Set<Class<?>> publishedEvents2) {
        this.name = name2;
    ...
    public static <T> Component<T> of(Class<T> anInterface, T value) {
        return builder(anInterface).factory(new Component$$ExternalSyntheticLambda2(value)).build();
    }
