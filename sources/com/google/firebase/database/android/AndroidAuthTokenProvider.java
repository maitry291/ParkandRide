...
public class AndroidAuthTokenProvider implements TokenProvider {
    ...
    public /* synthetic */ void m1364lambda$new$0$comgooglefirebasedatabaseandroidAndroidAuthTokenProvider(Provider authProvider) {
    ...
    public void getToken(boolean forceRefresh, TokenProvider.GetTokenCompletionListener listener) {
        ...
        if (authProvider != null) {
            authProvider.getAccessToken(forceRefresh).addOnSuccessListener(new AndroidAuthTokenProvider$$ExternalSyntheticLambda4(listener)).addOnFailureListener(new AndroidAuthTokenProvider$$ExternalSyntheticLambda5(listener));
        } else {
    ...
    public void addTokenChangeListener(ExecutorService executorService, TokenProvider.TokenChangeListener tokenListener) {
        this.deferredAuthProvider.whenAvailable(new AndroidAuthTokenProvider$$ExternalSyntheticLambda2(executorService, tokenListener));
    }
