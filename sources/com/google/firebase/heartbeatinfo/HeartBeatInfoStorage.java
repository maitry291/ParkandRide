    ...
    public synchronized void storeHeartBeat(long millis, String userAgentString) {
        ...
        synchronized (this) {
            ...
            if (!this.firebaseSharedPreferences.getString(LAST_STORED_DATE, "").equals(dateString)) {
                ...
                Set<String> userAgentDateSet = new HashSet<>(this.firebaseSharedPreferences.getStringSet(str, new HashSet()));
                userAgentDateSet.add(dateString);
                this.firebaseSharedPreferences.edit().putStringSet(str, userAgentDateSet).putLong(HEART_BEAT_COUNT_TAG, heartBeatCount + 1).putString(LAST_STORED_DATE, dateString).commit();
            }
        }
    }
